...
# Code below are from https://github.com/aws/aws-codebuild-docker-images/blob/master/ubuntu/ubuntu-base/14.04/Dockerfile
...
# Code below are from https://github.com/nodejs/docker-node/blob/master/8.2/Dockerfile
